...
public class SaturdayFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        dayOfWeekClassesAdapter = new DayOfWeekClassesAdapter(getContext(), getCourseDataInstance().getListOfClassesForDayOfWeek(SATURDAY));
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                ...
                ClassDataModel classDataModel = getCourseDataInstance().getListOfClassesForDayOfWeek(SATURDAY).get(i);
//                Toast.makeText(getContext(), "" + classDataModel.getLocation(), Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        super.onStart();
        adapter = new DayOfWeekClassesAdapterBRVAH(R.layout.class_layout, getCourseDataInstance().getListOfClassesForDayOfWeek(SATURDAY));
