...
public class ThursdayFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        dayOfWeekClassesAdapter = new DayOfWeekClassesAdapter(getContext(), getCourseDataInstance().getListOfClassesForDayOfWeek(THURSDAY));
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                ...
                ClassDataModel classDataModel = getCourseDataInstance().getListOfClassesForDayOfWeek(THURSDAY).get(i);
//                Toast.makeText(getContext(), "" + classDataModel.getLocation(), Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        super.onStart();
        adapter = new DayOfWeekClassesAdapterBRVAH(R.layout.class_layout, getCourseDataInstance().getListOfClassesForDayOfWeek(THURSDAY));
